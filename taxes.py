...
plot.subplot(121)
plot.plot(x, tax_nz.get_net_incomes(x), label="NZ Net Income", color="red")
plot.plot(x, tax_malta.get_net_incomes(x), label="Malta Net Income", color="green")
plot.plot(x, tax_italy.get_net_incomes(x), label="Italy Net Income", color="cyan")
plot.plot(x, tax_ireland.get_net_incomes(x), label="Ireland Net Income", color="brown")
plot.xlabel("Gross Income")
plot.ylabel("Net Income")

plot.figlegend()
plot.subplot(122)
plot.plot(x, 100*tax_nz.get_net_incomes(x)/x, label="NZ Net Income", color="red")
plot.plot(x, 100*tax_malta.get_net_incomes(x)/x, label="Malta Net Income", color="green")
plot.plot(x, 100*tax_italy.get_net_incomes(x)/x, label="Italy Net Income", color="cyan")
plot.plot(x, 100*tax_ireland.get_net_incomes(x)/x, label="Ireland Net Income", color="brown")
plot.xlabel("Gross Income")
